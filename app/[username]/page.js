                ...
                <div className='w-full md:w-2/3 lg:w-1/3 h-fit m-5 rounded-lg' >
                    <div className='w-full h-fit bg-indigo-950/60 p-5 rounded-lg'>
                        ...
                        <div className='flex items-center gap-5 my-3 p-4 border-2 border-indigo-500 rounded-lg bg-indigo-950'>
                            ...
                            <div className='w-[50px] h-[50px] bg-amber-300 text-indigo-950 border-2 border-white rounded-full flex items-center justify-center'>1</div>
                            <div className='w-[50px] h-[50px] bg-indigo-950 text-white border-2 border-white rounded-full flex items-center justify-center'>3</div>
