    ...
    return (
        <div className="">
            <div className="flex flex-col justify-center items-center gap-5 p-10 m-10 bg-indigo-950/30 ">
                ...
                <Link href={"/signup"}><button type="button" className="text-white bg-indigo-950 hover:bg-white border border-indigo-500 hover:text-black font-semibold rounded-lg px-5 py-2.5 w-fit ">
                    Get Started
                </button></Link>
