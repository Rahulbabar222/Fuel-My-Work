...
const FeatureCarousel = () => {
    ...
    return (
        <div className="flex justify-between items-center py-10 sm:p-10 m-10">
            ...
            transition-all duration-2000">
                ...
                <div className='flex gap-5 py-3'>
                    ...
                    <div onClick={()=>setIndex(2)} className={`w-6 h-3 border border-white rounded-full ${index===2?"bg-white":"bg-transparent"}`}></div>
                    <div onClick={()=>setIndex(3)} className={`w-6 h-3 border border-white rounded-full ${index===3?"bg-white":"bg-transparent"}`}></div>
                </div>
            </div>
