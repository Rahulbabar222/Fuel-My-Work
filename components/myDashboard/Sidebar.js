...
const Sidebar = ({setActiveComponent,activeComponent}) => {
    ...
    return (
        <>
            ...
            {/* My account */}
            <button onClick={()=>setActiveComponent("myAccount")} className={`flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full ${activeComponent==="myAccount"?"bg-gray-500/50":""} hover:bg-gray-500/50`} >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none">
            ...
            {/* payment Setting */}
            <button onClick={()=>setActiveComponent("paymentSetting")} className={`flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full ${activeComponent==="paymentSetting"?"bg-gray-500/50":""} hover:bg-gray-500/50`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none">
