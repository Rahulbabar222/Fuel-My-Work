...
const Sidebar = ({setActiveComponent,activeComponent,setClientConsole}) => {
    ...
    return (
        <>
            {/* home */}
            <button onClick={()=>{setActiveComponent("home"); setClientConsole(false);}} className={`flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full ${activeComponent==="home"?"bg-gray-500/50":""} hover:bg-gray-500/50`} >
            ...
            <Link onClick={()=>setClientConsole(false)} href={session ? `/${session.user.username}` : "/login"} target='_blank' className='flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full hover:bg-gray-500/50'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none">
             ...
             {/*  myProfile */}
             <button onClick={()=>{setActiveComponent("myProfile"); setClientConsole(false);}} className={`flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full ${activeComponent==="myProfile"?"bg-gray-500/50":""} hover:bg-gray-500/50`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none">
            ...
            {/* account setting */}
            <button onClick={()=>{setActiveComponent("accountSetting"); setClientConsole(false);}} className={`flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full ${activeComponent==="accountSetting"?"bg-gray-500/50":""} hover:bg-gray-500/50`} >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none">
            ...
            {/* Payout */}
            <button onClick={()=>{setActiveComponent("payout"); setClientConsole(false);}} className={`flex gap-3 items-center w-full py-2 px-5 mb-3 rounded-full ${activeComponent==="payout"?"bg-gray-500/50":""} hover:bg-gray-500/50`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none">
