                        ...
                        <div className='flex flex-col lg:flex-row items-center justify-between px-4'>
                            <div className='flex flex-col lg:flex-row items-center gap-5'>
                                ...
                                <div>
                                    ...
                                    <h3 className='text-gray-300 text-center lg:text-start'>fuelmywork.space/{session.user.username}</h3>
                                </div>
                            </div>
                            <button onClick={() => { copytoClipboard(`fuelmywork.space/${session.user.username}`); toast("Copied to clipboard ") }} className='flex mt-5 lg:mt-0 items-center gap-2 text-black bg-white px-3 py-1 rounded-full hover:scale-105'>
